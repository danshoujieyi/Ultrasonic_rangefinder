...
//等待信号响应
void OLED2_I2C_WaitAck(void) //测数据信号的电平
{
    OLED_SDA_Set();
    OLED2_IIC_delay();
    OLED_SCL_Set();
...
void OLED_Init(void)
{
    ...
    OLED_WR_Byte(Brightness,OLED_CMD);// Set SEG Output Current Brightness  //1~255;默认0X7F (亮度设置,越大越亮)亮度调节 0x00~0xff
